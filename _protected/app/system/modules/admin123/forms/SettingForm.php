...
class SettingForm
{
    ...
    public static function display()
    {
        ...
        $oForm->addElement(new \PFBC\Element\Select(t('Enable blocking for User:'), 'is_user_login_attempt', array('1' => t('Enable'), '0' => t('Disabled')), array('value' => DbConfig::getSetting('isUserLoginAttempt'), 'required' => 1)));
        $oForm->addElement(new \PFBC\Element\Select(t('Enable blocking for Affiliate:'), 'is_affiliate_login_attempt', array('1' => t('Enable'), '0' => t('Disabled')), array('value' => DbConfig::getSetting('isAffiliateLoginAttempt'), 'required' => 1)));
        $oForm->addElement(new \PFBC\Element\Select(t('Enable blocking for Admin:'), 'is_admin_login_attempt', array('1' => t('Enable'), '0' => t('Disabled')), array('value' => DbConfig::getSetting('isAdminLoginAttempt'), 'required' => 1)));
